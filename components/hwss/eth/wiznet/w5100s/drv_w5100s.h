...
inline esp_err_t W5100S_setPSID(hwss_io_t *io, const uint16_t *psid){
    uint16_t netv=hwss_htons(*psid);
    return io->write_buf(io,0,W5100S_REG_PSIDR,(uint8_t *)&netv,2);
}

inline esp_err_t W5100S_getPSID(hwss_io_t *io, uint16_t *psid){
    uint16_t netv;
...
inline esp_err_t W5100S_setPMRU(hwss_io_t *io, const uint16_t *pmru){
...
inline esp_err_t W5100S_setSn_FRAG(hwss_io_t *io, uint8_t sn, const uint16_t *frag){
    uint16_t netv=hwss_htons(*frag);
    return io->write_buf(io,0,W5100S_REG_Sn_FRAGR(sn),(uint8_t *)&netv, 2);
}

inline esp_err_t W5100S_getSn_FRAG(hwss_io_t *io, uint8_t sn, uint16_t *frag){
    uint16_t netv;
