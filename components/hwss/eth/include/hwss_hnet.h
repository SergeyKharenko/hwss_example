...
static inline esp_err_t hwss_hnet_set_gateway_addr(hwss_hnet_t *hnet, const hwss_ip_addr_t addr){
    return hnet->set_gateway_addr(hnet,addr);
}

static inline esp_err_t hwss_hnet_get_gateway_addr(hwss_hnet_t *hnet, hwss_ip_addr_t addr){
    return hnet->get_gateway_addr(hnet,addr);
}

static inline esp_err_t hwss_hnet_set_subnet_mask(hwss_hnet_t *hnet, const hwss_ip_addr_t mask){
    return hnet->set_subnet_mask(hnet,mask);
}

static inline esp_err_t hwss_hnet_get_subnet_mask(hwss_hnet_t *hnet, hwss_ip_addr_t mask){
    return hnet->get_subnet_mask(hnet,mask);
}

static inline esp_err_t hwss_hnet_set_source_addr(hwss_hnet_t *hnet, const hwss_ip_addr_t addr){
    return hnet->set_source_addr(hnet,addr);
}

static inline esp_err_t hwss_hnet_get_source_addr(hwss_hnet_t *hnet, hwss_ip_addr_t addr){
...
static inline esp_err_t hwss_hnet_get_unreachable_addr(hwss_hnet_t *hnet, hwss_ip_addr_t addr){
    return hnet->get_unreachable_addr(hnet,addr);
}

static inline esp_err_t hwss_hnet_get_unreachable_port(hwss_hnet_t *hnet, hwss_port_t *port){
