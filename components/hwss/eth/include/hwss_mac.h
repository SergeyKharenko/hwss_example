...
static inline esp_err_t hwss_mac_set_addr(hwss_mac_t *mac, const hwss_mac_addr_t addr){
    return mac->set_addr(mac,addr);
}

static inline esp_err_t hwss_mac_get_addr(hwss_mac_t *mac, hwss_mac_addr_t addr){
