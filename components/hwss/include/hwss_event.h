...
ESP_EVENT_DEFINE_BASE(HWSS_INTER_SOCK0_EVENT);
ESP_EVENT_DEFINE_BASE(HWSS_INTER_SOCK1_EVENT);
ESP_EVENT_DEFINE_BASE(HWSS_INTER_SOCK2_EVENT);
ESP_EVENT_DEFINE_BASE(HWSS_INTER_SOCK3_EVENT);
ESP_EVENT_DEFINE_BASE(HWSS_INTER_SOCK4_EVENT);
ESP_EVENT_DEFINE_BASE(HWSS_INTER_SOCK5_EVENT);
ESP_EVENT_DEFINE_BASE(HWSS_INTER_SOCK6_EVENT);
ESP_EVENT_DEFINE_BASE(HWSS_INTER_SOCK7_EVENT);

extern esp_event_base_t HWSS_EVENT_BASE_SOCKET_LIST[];
